...
3. Бот создает `order`
4. Пользователь переводит оплату вручную на номер в `Т-Банк`
5. Нажимает `Я оплатил`
6. Администратор подтверждает перевод в Telegram
7. Backend создает или продлевает VPN-доступ
8. Пользователь получает subscription URL, QR и инструкции
